...
public class Tutorial {
    ...
    public Tutorial(final MainActivity activity) {
        ...
        sv.setContentTitle(activity.getResources().getString(R.string.showcase_title));
       ...
       /* ShowcaseView.ConfigOptions co = new ShowcaseView.ConfigOptions();
        ...
        sv.overrideButtonClick(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (svCounter) {
                    case 0:
                        sv.setContentTitle(activity.getResources().getString(R.string.showcase_title_2));
                    ...
                    case 8:
                        ...
                        sv.setContentTitle(activity.getResources().getString(R.string.showcase_title_6));
                        sv.setContentText(activity.getResources().getString(R.string.showcase_message_6));
                        sv.setShowcase(ViewTarget.NONE, true);
//                        sv.setShowcase(ShowcaseView.NONE);
